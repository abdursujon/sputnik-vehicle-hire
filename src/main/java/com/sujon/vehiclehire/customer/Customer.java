package com.sujon.vehiclehire.customer;
...
public class Customer {
    ...
    /**
     * Constructor for objects of class main.Customer
     */
    ...
    public void printDetails() {
        System.out.println("main.Customer ID: " + customerID + ", Surname: " + surname + ", First Name: " + firstName + ", Other Initials: " + otherInitials + ", Title: " + title);
    }
